...
AArduinoFan_SandboxHud::AArduinoFan_SandboxHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AArduinoFan_SandboxHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if( bHMDDeviceActive == false )
	{
		...
		AArduinoFan_SandboxPawn* Vehicle = Cast<AArduinoFan_SandboxPawn>(GetOwningPawn());
